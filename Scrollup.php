...
class Scrollup extends Widget
{
	 ...
	 */
	private $_supportedThemes = [self::THEME_IMAGE,self::THEME_LINK,self::THEME_PILLS,self::THEME_TAB];
	/**
	 * @var array list of supported animation mode
	 */
	private $_supportedAnimation = [self::ANIMATION_FADE, self::ANIMATION_NONE, self::ANIMATION_SLIDE];
	/**
